        ...
        <div className='flex justify-center relative bg-black w-full p-5 lg:p-48 mx-auto max-w-[90rem]'>
            <div className='grid grid-cols-1 md:grid-cols-2'>
                <div className='flex lg:pr-20 flex-col'>
                    <div>
                        <div><span className='text-white text-[2rem] md:text-[3rem] leading-[40px]'>Start attracting<br></br> more clients today!</span></div>
                    </div>
                    ...
                    <div className='mx-auto md:mx-0 pt-8'>
